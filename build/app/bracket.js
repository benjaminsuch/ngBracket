...
app.directive('ngBracket', ['data', 'layoutService',
  function(data, layoutService) {
    return {
      restrict: 'E',
      templateUrl: 'app/partials/bracket.tpl.html',
      replace: false,
      scope: {
        bracketData: '='
      },
 ...
 */
  ...
  .directive('match', ['connectorService', 'layoutService', 'data', '$filter', 'highlight',
    function(connectorService, layoutService, data, $filter, highlight) {
      return {
        restrict: "E",
        scope: false,
        templateUrl: 'app/partials/match.tpl.html',
        replace: true,
        link: {
  ...
  .directive('score', ['data',
    function(data) {
      return {
        ...
        templateUrl: 'app/partials/score.tpl.html',
  ...
  .directive('team', ['data', 'highlight',
    function(data, highlight) {
      return {
        restrict: 'E',
        templateUrl: 'app/partials/team.tpl.html',
        replace: true,
        scope: {
          team: '=',
          teamdetails: '=',
